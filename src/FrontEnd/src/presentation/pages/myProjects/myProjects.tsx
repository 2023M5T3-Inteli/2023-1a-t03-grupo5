...
const MyProjects: React.FC<Props> = (props: Props) => {
  ...
  return (
    <div className='home'>
      ...
      {
        openViewModal && <Modal closeArrow={true} closeModal={() => toggleViewModal()} content={<VisualizeProject user={props.user} />} />
      }
      {
        ...
        <div style={{"width": "100%"}}>
          <div className="options">
            <div className='option1'>
              <button className='btnProjects'>Created Projects</button>
            </div>
            <div className='option2'>
              <button className='btnProjects'>Participated Projects</button>
            </div>
          </div>
        </div>
